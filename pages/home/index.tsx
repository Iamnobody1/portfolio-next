            ...
            <div className="text-[#6B728E] text-lg">
                ...
                <div className="relative p-6 mx-12">
                    ...
                    <div className="ml-[200px] pl-6 flex justify-between items-center">
                        ...
                        <div>
                            <a type="button" target="_blank" href="https://github.com/Iamnobody1" rel="noopener noreferrer" className="text-white bg-rose-700 hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                Github
                            </a>
                        </div>
                    </div>
